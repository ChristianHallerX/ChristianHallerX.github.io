...
Transactions move around values between owners. Fore example money between bank accounts. This means a transaction contains a subtraction and an addition part that both have to succeed.
