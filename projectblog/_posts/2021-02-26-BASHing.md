...
Sort model files with a for-loop and case-conditions.
Move tree models files to tree-model folder, remove all other model files.

~~~bash
#!/bin/bash

# loop through files in 'model_out/'
for file in model_out/*
do
    # catinto each file's contents
    case $(cat $file) in
	
		# Match on tree models
		*"Random Forest"*|*GBM*|*XGBoost*)
		mv $file tree_models/ ;;
		
		# Match on non-tree models
		*KNN*|*Logistic*)
		rm $file ;;
