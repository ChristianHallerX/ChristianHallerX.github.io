...
You only look once (YOLO, empahsis on **once**) is an object detection system using Convolutional Neural Networks (CNN) targeted for real-time processing of camera feeds of all sorts. YOLO divides the image into tiles (e.g. 13x13) and runs the inference for object bounding boxes and object classification on all image tiles simultaneously through the CNN, which makes it a lot faster than previous algorithms. Self-driving cars heavily rely on such algorithms, since they need to identify other cars on the street with a camera mounted in the grille.
...
Diagram Source: <a href="https://www.doi.org/10.3390/s19194263" target="_blank">Seong et al., 2019</a>
...
Source: <a href="https://unsplash.com/" target="_blank">https://unsplash.com/</a>
